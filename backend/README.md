...
## Project Structure
    ...
    ├── wandering_firefly_29609  # Django project configurations
...
1. Clone this repo and `cd wandering_firefly_29609`
...
2. Clone this repo and `cd wandering_firefly_29609`
